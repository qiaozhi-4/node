...
1. 2 天后的下午 5 点执行 /bin/ls /home										  ![1670673294184](D:\笔记\linux.assets\at-定时任务-应用实例-1.png)

2. atq 命令来查看系统中没有执行的工作任务                    ![1670672580855](D:\笔记\linux.assets\at-定时任务-应用实例-2.png)

3. 明天 17 点钟，输出时间到指定文件内 比如 /root/date100.log ![1670673204545](D:\笔记\linux.assets\at-定时任务-应用实例-3.png)

4. 2 分钟后，输出时间到指定文件内 比如 /tmp/date200.log ![1670673638676](D:\笔记\linux.assets\at-定时任务-应用实例-4.png)
...
5. 删除已经设置的任务 ,
   ...
   删除前![1670674123325](D:\笔记\linux.assets\at-定时任务-应用实例-5.png)

   删除后![1670674176785](D:\笔记\linux.assets\at-定时任务-应用实例-6.png)
...
3. 对于 SCSI 硬盘则标识为“sdx~”，SCSI 硬盘是用“sd”来表示分区所在设备的类型的，其余则和IDE 硬盘的表示方法一样                                                                       ![1670983798084](D:\笔记\linux.assets\linux-硬盘说明-1.png)
...
###### 步骤一: 添加硬盘
 ...
 在【虚拟机】菜单中，选择【设置】，然后设备列表里添加硬盘，然后一路【下一步】，中间只有选择磁盘大小的地方需要修改，至到完成。然后重启系统（才能识别）！ ![1670985433690](D:\笔记\linux.assets\挂载案例-添加硬盘-1.png)
...
- 命令 : df -h 
- 实例 :                                                                ![1670986650562](D:\笔记\linux.assets\磁盘情况查询-1.png)
...
- 实例  :  
  ...
  - -s 指定目录占用大小汇总 -h 带计量单位 -a 含文件 --max-depth=1 子目录深度 -c 列出明细的同时，增加汇总值							
    ...
    du -hac --max-depth=1 /opt
     ...
     ![1670986936996](D:\笔记\linux.assets\磁盘情况查询-2.png)
...
![1671005710803](D:\笔记\linux.assets\网络配置-查看ip和网关-1.png)

###### 查看网关

![1671005887383](D:\笔记\linux.assets\网络配置-查看ip和网关-2.png)
